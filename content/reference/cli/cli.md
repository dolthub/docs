...
Valid commands for dolt are
       ...
       filter-branch - Edits the commit history using the provided query.
          ...
          query-diff - Calculates table diff between two queries.
```
...
This data is local to a Dolt database and never included when pushing, pulling, or cloning a Dolt database. 
This means when you clone a Dolt database, it will not have any reflog data until you perform operations that change what 
commit branches or tags reference.
