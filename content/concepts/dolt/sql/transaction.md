...
Note, you can make every transaction COMMIT a Dolt commit by setting the [system variable](./system-variables.md), [`@@dolt_transaction_commit`](../../../reference/sql/version-control/dolt-sysvars#dolt_transaction_commit)
