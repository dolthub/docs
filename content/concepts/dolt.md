...
In order to achieve the above at scale, we needed to start at the bottom; the storage engine of the database. [Dolt is built from the storage engine up](../architecture/architecture.md) to offer you the Git experience in a SQL database.  
