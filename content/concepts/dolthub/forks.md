...
Using forks to propose changes is commonly used for [data bounties](../../products/dolthub/data-bounties.md). You can create a fork, making changes to your fork, and then submit a [pull request](./prs.md) in the original database.
