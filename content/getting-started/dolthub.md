...
Publishing data is equally easy once it's in the Dolt format. In [another section](../writing-to-dolt) we showed how to write data to Dolt. Let's assume we have some data in a local Dolt repository:
...
![Pull Request Workflow](../../images/pull_request_workflow.png)
...
![Forking a Database ](../../images/forked_dolthub_database_with_upstream.png)
