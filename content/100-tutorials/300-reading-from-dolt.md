...
# Python
We can the same set of operations in Python. If you haven't installed Doltpy, then refer to the [installation tutorial](../installation) for details, but if you're using `pip` it's simple:
```
$ pip install doltpy
.
.
