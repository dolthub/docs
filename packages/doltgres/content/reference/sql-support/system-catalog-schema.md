...
{% hint style="info" %}
We have not yet implemented [OIDs](./supported-types.md#oid-alias-types) which prevent a lot of the partially implemented tables from being useful
{% endhint %}
...
| View                                                                                                                 | Supported | Notes and limitations |
| :------------------------------------------------------------------------------------------------------------------- | :-------- | :-------------------- |
...
{% hint style="info" %}
Supported functions work as `SELECT [function]`, but not yet as `SELECT _ FROM [function]`.
{% endhint %}
