...
Here are Dolt's sqllogictest results for version `1.39.3`.  Tests that
...
Here are Dolt's function coverage results for version `1.39.1`.
...
version `1.39.1`. These are edge cases that we know are failing for 
