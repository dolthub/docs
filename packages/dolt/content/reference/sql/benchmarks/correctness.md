...
Here are Dolt's sqllogictest results for version `1.35.13`.  Tests that
...
Here are Dolt's function coverage results for version `1.35.9`.
...
version `1.35.9`. These are edge cases that we know are failing for 
