...
## <ins>Backing up and restoring remote data, user uploaded data, and Dolt server data with Docker</ins>
...
## <ins>Backing up and restoring the Dolt Server using the `dolt backup` command</ins>
